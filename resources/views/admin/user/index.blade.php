        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table" id="example">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  @endif</td>
                  <td>
                   <a href="{{url('admin/datauser/update/'.$q->id)}}" class="btn btn-outline-warning btn-sm">Aktifkan</a>
            ...
            <li class="list-group-item float-left">
              <a href="{{url('admin/datauser/add')}}" class="btn btn-outline-primary btn-sm">Tambah Data</a>
            </li>
          </div>
        </div>
      </div>
